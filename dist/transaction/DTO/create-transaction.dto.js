...
__decorate([
    (0, class_validator_1.IsNumber)({}, { message: 'O montante da transação deve ser um número' }),
    (0, class_validator_1.IsNotEmpty)({ message: 'O valor deve ser positivo e existir' }),
    __metadata("design:type", Number)
], CreateTransactionDto.prototype, "amount", void 0);
__decorate([
    (0, class_validator_1.IsDateString)({}, { message: 'A data deve estar no formato ISO (Ex: 2026-03-23)' }),
